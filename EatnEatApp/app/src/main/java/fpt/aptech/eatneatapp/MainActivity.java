...
import fpt.aptech.eatneatapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_daily_meal, R.id.nav_cart,R.id.nav_order,R.id.nav_sign_out)
        ...
        TextView tvName = header.findViewById(R.id.nameUser);
